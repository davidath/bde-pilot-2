            ...
            req.onloadend = function() {
                ...
                if (resp["scores"][0] - resp["scores"][2] != 0) {
                    ...
                    for (var i = 0; i < resp['scores'].length; i++) {
                        if (resp['scores'][i] != 0) {
                            res_str += '<tr><td style="padding: 8px;">'+resp['stations'][i] + '</td><td style="padding: 8px;">' + resp['scores'][i] + '</td><td style="padding: 8px;"><input type="radio" onClick=uiCheck('+i+')name="ui_opt" value="disp"><form id="ui_form_'+i+'">Dispersion<input type="radio" onClick=uiCheck('+i+') name="ui_opt" value="pop">Population</form><div id="loader_ic_'+i+'" class="loader" style="display:none;"></div></td></tr>';
                            }
                    }
                    res_str += '</table>';
